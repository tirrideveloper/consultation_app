...
class EnterNewCase extends StatefulWidget {
  const EnterNewCase({Key key}) : super(key: key);
...
class _EnterNewCaseState extends State<EnterNewCase> {
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Foto ekle", style: TextStyle(color: Theme.of(context).primaryColor, fontSize: 15),),
                          SizedBox(width: 5),
                          Icon(
                            Icons.arrow_forward,
                            size: 17,
  ...
  CaseModel _caseKaydet() {
    ...
    /*var result = await _caseModel.saveCase(_case);
      if (result) {
